...
var _default = function _default() {
  ...
  description.setAttribute('class', 'preparation__description'); // children
  ...
  imgCasaEnVenta.setAttribute('src', '../assets/images/CasaEnVenta.png'); // preparationView elements

  preparationView.appendChild(image);
  preparationView.appendChild(description); // children
