...
var _default = function _default() {
  ...
  imgPromo.setAttribute('src', '../assets/images/Promoción.png'); // tramiteView elements

  tramiteView.appendChild(description);
  tramiteView.appendChild(image); // children
